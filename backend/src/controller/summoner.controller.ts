...
export const createSummoner = async (region: string, summonerName: string) => {
  ...
  console.log(newSummonerMatches);
...
//export const SummonerController = router;
